...
public class CounterTest05 extends BaseTest {
  ...
  public void testCounterIncreaseCoordinates() {
    ...
    assertThat(newCount - oldCount).as("check counter increased").isEqualTo(times);
  }
  ...
  private void testCounterIncrease(WebElement incrementButton, int times) {
    int oldCount = Integer.parseInt(counter.getText());
    for (int i = 1; i <= times; i++) {
